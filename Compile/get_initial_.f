     ...
     &          'Processing data for time =', tdays, 'record =', indx
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (zeta(-2,-2,1), ncid, varid,
     &                                         indx, r2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (ubar(-2,-2,1), ncid, varid,
     &                                         indx, u2dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                      ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (vbar(-2,-2,1), ncid, varid,
     &                                         indx, v2dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                       ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (u(-2,-2,1,1), ncid, varid,
     &                                        indx, u3dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                     ininame(1:lstr)
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (v(-2,-2,1,1), ncid, varid,
     &                                        indx, v3dvar)
        if (ierr .ne. nf_noerr) then
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (t(-2,-2,1,1,itrc), ncid,  varid,
     &                                               indx, r3dvar)
          if (ierr .ne. nf_noerr) then
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (trb(-2,-2,0,1,itke), ncid,
     &                                    varid, indx, w3dvar)
          if (ierr .ne. nf_noerr) then
            if (mynode.eq.0) write(stdout,2) vname(1,indxTke)(1:lvar)
     &                , indx, ininame(1:lstr), nf_strerror(ierr)
            goto 99
          endif
        else
        if (mynode.eq.0) write(stdout,3)
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (trb(-2,-2,0,1,igls), ncid,
     &                                    varid, indx, w3dvar)
          if (ierr .ne. nf_noerr) then
            if (mynode.eq.0) write(stdout,2) vname(1,indxGls)(1:lvar)
     &                , indx, ininame(1:lstr), nf_strerror(ierr)
            goto 99
          endif
        else
     ...
     &                                                    varid)
        if (ierr .eq. nf_noerr) then
          ierr=nf_fread (Lscale(-2,-2,0), ncid,
     &                                    varid, indx, w3dvar)
          if (ierr .ne. nf_noerr) then
            if (mynode.eq.0) write(stdout,2) vname(1,indxLsc)(1:lvar)
     &                , indx, ininame(1:lstr), nf_strerror(ierr)
            goto 99
          endif
        else
