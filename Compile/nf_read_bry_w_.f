     ...
     &                     ,' mynode =', mynode
        ...
        write(*,'(/1x,2A,I4/)') 'ERROR in nf_read_bry_NS_W: ',
     &                          'illegal grid type', type
      endif
      nf_read_bry_NS_W=ierr
      return
      end
     ...
     &                     ,' mynode =', mynode
        ...
        write(*,'(/1x,2A,I4/)') 'ERROR in nf_read_bry_EW_W: ',
     &                          'illegal grid type', type
      endif
      nf_read_bry_EW_W=ierr
      return
      end
